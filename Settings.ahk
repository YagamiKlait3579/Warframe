...
;--------------------------------------------------
MagusAnomalyKey    = F13     ; Вкл\Выкл (или удержание) применение аномалии волхва
...
;--------------------------------------------------
FirstAbilityKey   = 1       ; Способность A
SecondAbilityKey  = 2       ; Способность B
ThirdAbilityKey   = 3       ; Способность C
FourthAbilityKey  = 4       ; Способность D
